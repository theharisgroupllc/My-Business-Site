...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-xl border border-slate-200 p-6">
      ...
      <div className="mt-4 space-y-3">
        ...
        <button disabled={state === "submitting"} className="rounded-md bg-brand-navy px-5 py-3 text-sm font-semibold text-white hover:bg-brand-slate disabled:cursor-not-allowed disabled:opacity-70">
